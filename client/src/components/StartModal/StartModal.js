...
export default function StartModal({ setSecret }) {
  ...
  const handleStart = () => {
    const secret = secretWord(wordL);
    console.log(secret, '50');
    setSecret(secret);
    setOpen(false);
  };
  ...
  return (
    <div>
      <Button onClick={handleOpen}>Начать новую игру</Button>
      <Modal
        open={open}
        // onClose={handleClose}
